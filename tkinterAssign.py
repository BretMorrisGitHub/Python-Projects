...
class ParentWindow(Frame):
    def __init__ (self, master):
        ...
        self.lblFName.grid(row=0,column=0,padx=(10,10),pady=(10,0))

        self.lblLName = Label(self.master,text='Last Name: ',font=("Helvetica", 16), fg='black', bg='darkgray')
        self.lblLName.grid(row=1,column=0,padx=(10,10),pady=(10,0))

        self.lblDisplay = Label(self.master,text='',font=("Helvetica", 16), fg='black', bg='darkgray')
        self.lblDisplay.grid(row=3,column=1,padx=(30,0),pady=(30,0))
        
        self.txtFName = Entry(self.master,text=self.varFName,font=("Helvetica", 16), fg='black', bg='lightblue')
        self.txtFName.grid(row=0,column=1,padx=(10,10),pady=(10,0))

        self.txtLName = Entry(self.master,text=self.varLName,font=("Helvetica", 16), fg='black', bg='lightblue')
        self.txtLName.grid(row=1,column=1,padx=(10,10),pady=(10,0))
